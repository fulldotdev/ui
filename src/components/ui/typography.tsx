  ...
  ],
  {
    variants: {
      size: {
        ...
        lg: "text-lg [&_h1]:text-4xl [&_h2]:text-4xl [&_h3]:text-3xl [&_h4]:text-2xl [&_h5]:text-xl [&_h6]:text-lg max-w-3xl",
...
function Typography({
  ...
  return (
    <div className={cn(typographyVariants({ size }), className)} {...props} />
  )
}
