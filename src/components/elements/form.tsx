...
// Base interface for typed Form components
// This provides type safety for all Form components by ensuring:
...
interface Props extends React.ComponentProps<"form"> {
  ...
  fields?: (
    | ({
      ...
      } & Omit<React.ComponentProps<typeof FormInput>, "control">)
    | ({
        type: "textarea"
      } & Omit<React.ComponentProps<typeof FormTextarea>, "control">)
    | ({
        type: "select"
      } & Omit<React.ComponentProps<typeof FormSelect>, "control">)
    | ({
        type: "radio"
      } & Omit<React.ComponentProps<typeof FormRadio>, "control">)
    | ({
        type: "checkbox"
      } & Omit<React.ComponentProps<typeof FormCheckbox>, "control">)
    | ({
        type: "choice"
      } & Omit<React.ComponentProps<typeof FormChoice>, "control">)
    | ({
        type: "multichoice"
      } & Omit<React.ComponentProps<typeof FormMultiChoice>, "control">)
    | ({
        type: "slider"
      } & Omit<React.ComponentProps<typeof FormSlider>, "control">)
    | ({
        type: "date"
      } & Omit<React.ComponentProps<typeof FormDate>, "control">)
  )[]
  submit?: string
  description?: string
}
