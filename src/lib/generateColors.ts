...
export function generateColors({
  ...
  const {
    ...
    accentContrast: primaryContractDark,
    accentScaleWideGamut: primaryDark,
    grayScaleWideGamut: baseDark,
  } = darkColors
...
// Below is copied from https://github.com/radix-ui/website/blob/main/components/generateRadixColors.tsx
