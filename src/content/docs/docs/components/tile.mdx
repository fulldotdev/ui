...
Use `variant="plain"` when you need clickable link semantics without tile hover
or decorative styles.
...
Use `plain` when the tile should stay clickable but inherit visual styling from
the parent layout.
...
<div class="space-y-4">
  <Tile href="#">
    <TileContent>
      <TileTitle>Default Variant</TileTitle>
      <TileDescription>Hover ring and background are applied by Tile</TileDescription>
    </TileContent>
  </Tile>
  ...
  <div class="rounded-sm border p-4">
    <Tile href="#" variant="plain">
      <TileContent>
        <TileTitle>Plain Variant</TileTitle>
        <TileDescription
          >Still clickable, but with no Tile hover styles</TileDescription
        >
      </TileContent>
    </Tile>
  </div>
...
<div class="grid w-full gap-4">
  ...
  <Tile href="#" variant="plain">
    <TileContent>
      <TileTitle>Plain Variant</TileTitle>
      <TileDescription>Clickable without Tile hover visuals</TileDescription>
    </TileContent>
  </Tile>
</div>
```
