...
Fulldev/ui is built with vanilla Astro components, without framework dependencies. It uses a similar API to shadcn/ui, but with a focus on content-first components like section and tile. Give it a try and let us know what you think!
