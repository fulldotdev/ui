...
seo:
  ...
  description: Make websites with pre-built components and blocks
...
sections:
  hero:
    ...
    badge:
      as: a
      text: We just released a massive update 🎉
      href: https://discord.gg/vXZqMbadm8
    heading: The Astro UI library to build content sites
    text: Make websites with pre-built components and blocks
    buttons:
      - text: Get Started
