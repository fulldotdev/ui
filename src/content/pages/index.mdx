...
<Section class="py-0">
  <SectionContainer
    class="grid gap-6 px-0 lg:grid-cols-[0.75fr_1.25fr] lg:items-start lg:gap-10"
  >
    ...
    <TileGroup size="lg" class="sm:grid-cols-1">
      <Tile
        variant="outline"
        class="from-primary/6 via-primary/2 to-border bg-linear-to-br p-px"
      >
        <TileContent
          class="from-primary/3 via-primary/1 to-background rounded-[11px] bg-linear-to-br"
        >
          <div class="space-y-2">
            ...
            <p class="text-muted-foreground max-w-2xl text-sm leading-6">
              Use Shadcn-style primitives plus Astro extras for content
              websites: typography, pricing, ratings, media, and docs
              navigation.
            </p>
          </div>
          <Button href="/components/" size="sm" class="w-fit">
            View components
          </Button>
        </TileContent>
      </Tile>
      ...
      >
        ...
        >
          ...
          <Button href="/blocks/" size="sm" class="w-fit"> View blocks </Button>
        </TileContent>
      </Tile>
    </TileGroup>
  </SectionContainer>
...
<Section class="py-0">
  <SectionContainer class="px-0">
    <TileGroup
      class="gap-0 overflow-hidden rounded-xl border sm:grid-cols-1 md:grid-cols-2"
    >
      <Tile variant="default" class="rounded-none">
        <TileContent class="gap-5">
          <div class="space-y-2">
      ...
      <Tile
        variant="default"
        class="border-border rounded-none border-t md:border-t-0 md:border-l"
      >
        <TileContent class="gap-5">
          <div class="space-y-2">
