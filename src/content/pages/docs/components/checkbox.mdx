...
This Astro checkbox is intentionally implemented as a native
`<input type="checkbox">`.

- It keeps native form submission, reset, label association, and validation
  behavior.
- It stays SSR-friendly and requires no client-side JavaScript.
- It is not meant to mirror the internal root/indicator structure of the React
  shadcn reference.
