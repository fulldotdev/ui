...
Keep `"tsx": true` in `components.json`, including for Astro projects. The registry
ships TypeScript; disabling this setting can make shadcn attempt to parse Astro
components as JavaScript.
