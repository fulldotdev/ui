...
Fulldev UI is distributed as a shadcn registry for Astro projects. The setup
below keeps your project aligned with the examples in this documentation.
...
```bash
npx shadcn@latest add @fulldev/button @fulldev/item @fulldev/card
```
