...
settings: sidebar
title: Theming
description: Theming is done with CSS variables.
---
...
With the fulldev-ui integration you can easily set a theme and generate a radix color palette. See the <Link href="/integration">integration page</Link> for details.
