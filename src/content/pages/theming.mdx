...
With the FullUI integration you can easily set a theme and generate a radix color palette. See the <Link href="/integration">integration page</Link> for details.
