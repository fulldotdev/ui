...
<Alert>
  ...
  <AlertDescription>
    ...
    `simple-icons/icons/github.svg`. Avoid named imports from the package entrypoint
    because they can make the dev server scan much more icon code and noticeably
    slow startup and HMR. The Fulldev `Icon` component uses static SVG packages
    for content-owned dynamic icon names.
  </AlertDescription>
</Alert>
