...
<Section>
  <SectionContainer>
    ...
    <SectionDescription>
      Use the container for the section content you want aligned.
    </SectionDescription>
  </SectionContainer>
</Section>
```
...
- `SectionTitle` renders the section heading with the shared type scale. Use
  `as="h1"` or `as="h3"` to change the heading level.
- `SectionDescription` renders the supporting paragraph under a title.
