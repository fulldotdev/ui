...
Initialize nested interactive components before their parent detaches them, or
keep the default eager strategy. Both modes include the content in server-rendered
