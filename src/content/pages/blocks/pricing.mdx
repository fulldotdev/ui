  ...
  plans={[
    {
      ...
      action: { label: "Get started", href: "/docs/", variant: "outline" },
    },
    {
      name: "Team",
    ...
    },
    {
      ...
      action: { label: "Contact sales", href: "/docs/", variant: "outline" },
    },
  ]}
/>
```
  ...
  plans={[
    {
      ...
      action: { label: "Start free trial", href: "/docs/", variant: "outline" },
    },
    {
      name: "Pro",
      ...
      action: { label: "Start free trial", href: "/docs/" },
    },
  ]}
/>
```
...
<Pricing3Block
  ...
  offer={{
    name: "Studio bundle",
    description: "Full access for teams managing content, product, and marketing.",
    price: 249,
    currency: "USD",
    unit: "month",
    features: [
    ...
    action: { label: "Get started today", href: "/docs/" },
  }}
/>
```
