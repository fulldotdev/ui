...
import SwatchBookIcon from "@lucide/astro/icons/swatch-book"
...
<Features2Block
  ...
  items={[
    ...
    },
    {
      ...
      description:
        "Examples remain source-driven and easy to ship through the component registry.",
    },
  ]}
/>
```
...
<Features4Block
  ...
  items={[
    ...
    },
    {
      ...
      description:
        "Install individual components through the registry CLI. No monolithic dependency to manage.",
