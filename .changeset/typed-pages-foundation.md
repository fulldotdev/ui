...
Ship an optional page foundation with one path-driven pages collection, strict schemas per type, one layout per type, locale folders, translation pairing, and structured data. Overview pages render their Markdown body and list validated references or direct children. Routing, breadcrumbs, Markdown links, and the sitemap share one validated pages module; the loader rejects route collisions and the strict schemas reject slug overrides and undeclared fields.
