...
The Tag component is used as the foundation of every other components. This means all features described here are available on every other component too.
...
**This prop cascades down to all children.**
