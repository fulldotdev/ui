...
### Spacing classes
Spacing often for padding and margin. Example usage would be `pt-space-1`.
...
### Radius classes
With this you can set the radius of certain elements. Example usage would be `rounded-radius-1`.
- `...-radius-1`
- `...-radius-2`
- `...-radius-3`

### Color classes
Customizing the following colors can be done by following the [theming](/overview/theming) guide. Example usage would be `bg-variant` or `text-variant`.
