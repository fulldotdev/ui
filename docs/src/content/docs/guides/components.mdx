...
| `{...}` | [`HTMLAttributes`](https://www.w3schools.com/tags/ref_attributes.asp) | All html attributes, depending on value of `as` |
...
| `scale` | `number` | Scaling factor for this and all children |
| `scale` | `number` | Scaling factor for this and all children |

1. **as**
1. All components accepts each 
