...
Applies a margin around certain child elements and applies the background and border set in your [theming](/overview/theming)

You can use the variant prop explained below to adjust these styles.

```astro live
---
import { Card, Heading, Paragraph } from '@fullui/ui'
---
...
Choose a predifined density, or a custom value defined like explained in the [Theming guide](/overview/theming).
