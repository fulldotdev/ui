...
export * from './components/Children.astro'
export { default as Children } from './components/Children.astro'
...
export * from './components/DynamicTag.astro'
export { default as DynamicTag } from './components/DynamicTag.astro'
